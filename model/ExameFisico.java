...
public class ExameFisico {
    ...
    private String NívelConsciência;
    private String EscoreCorporal;
    private double TemperaturaCorporal;
    private int FrequênciaRespiratório;
    private int FrequênciaCardiovascular;
    private int TempoPreenchimentoCapilar;
    private int Pulso;
    private String Hidratação;
    private String LinfonodosSubmandibular; 
    private String LinfonodosPréEscapulares;
    private String LinfonodosPoplíteos;
